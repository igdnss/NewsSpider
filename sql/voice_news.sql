...
CREATE TABLE `news_info_tbl` (
  ...
  `rawPath` varchar(500) DEFAULT NULL COMMENT '原始新闻的本地路径',
  `absPath` varchar(500) DEFAULT NULL COMMENT '新闻摘要文本的本地路径',
  `voicePath` varchar(500) DEFAULT NULL COMMENT '新闻摘要语音的本地路径',
  ...
  `url` varchar(500) DEFAULT NULL COMMENT '新闻页的远程地址',
